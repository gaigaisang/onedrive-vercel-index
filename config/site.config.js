...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'gaigaisang@xiaogai.onmicrosoft.com',
  ...
  protectedRoutes: ['/video', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:gaigaisang@outlook.com',
